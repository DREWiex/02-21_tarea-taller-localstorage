...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const captureListaUno = document.querySelector('#lista1');
  const captureListaDos = document.querySelector('#lista2');

  //* Arrays *//

  const arrayProductos = [ //* lista original de productos
    {
        id: 'a-1',
        fruta: 'Plátano'
    },
  ...
  captureListaUno.addEventListener("click", ({target}) => { //! incompleto //* destructuración de ev (ev.target)
